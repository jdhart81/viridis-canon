...
| **MRAB** | `MRAB.lean` | **0** | COMPILED — **standalone core-extension candidate, held out of the frozen spine** | Multi-Ring Alignment Bound (Thm 1; the Polymath Paradox + wu-wei saturation + UAIB reduction). 10 thms; Aristotle `65347d17`, 2026-06-21. Published standalone on Zenodo 2026-06-22; queued for a future curated spine v10 wave (spine frozen at v9). |
