...
theorem window_energy_ledger
  ...
  unfold information3 energy3
  linarith

theorem aggregate_information_ceiling
    (ε I E : ℝ) (hε : 0 < ε) (hledger : ε * I ≤ E) :
    I ≤ E / ε := by
  have hprod : I * ε ≤ E := by nlinarith
  exact (le_div_iff₀ hε).2 hprod
